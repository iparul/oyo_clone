...
const Hotel = ({ e }) => {
    return (
        <div className="border-2 border-red-500 rounded-lg h-96 w-full mb-5 p-5">
            <div className="flex">
                <Image src={e?.banner} alt="imagHotel" width={200} height={200} className="h-80 w-80 mr-3" />
                ...
                <div className="ml-20">
                    ...
                    <div className="text-2xl my-5"><span className="font-bold ">Facilities:</span>
                        <ul className="flex" >
                            {
                    ...
                    <div className="flex items-center">
                        ...
                        <Link href={`/hotels/${e?._id}`} className="text-xl font-bold text-red-600 ml-10">See Details</Link>
                    </div>
                </div>
            </div>
